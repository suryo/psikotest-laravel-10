...
<div class="sidebar">
    <div class="logo">
        <a href="{{ route('landing') }}">
            ...
            {{-- <h1>Your Logo</h1> --}}
            <img src="{{ asset('assets/image/logo/zonainformatika.jpeg') }}" class="card-img-top" alt="ZonaPsikologi">
        </a>
    </div>
    <ul>
        <li><a href="{{ route('dashboard') }}" style="color: #333;"><i class="bi bi-house-door"></i> Dashboard</a></li> <!-- Warna biru untuk tautan -->
        <hr>
        <li><a href="" style="color: #333;"><i class="bi bi-laptop"></i> User</a></li> <!-- Warna biru untuk tautan -->
